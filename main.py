...
def converter_binario(): #criação da função que converterá em binários
    ...
    while(valorcont>0): #estrura que repetirá o código, até que o valor chegue a 0
...
botao_binario=Button(janela, text="Conversão para Binário", width=20, command=converter_binario)
#criação do botão de conversão para binário. 'Command' chamará a função criada anteriormente

botao_binario.place(x=165, y=100) #posicionamento do botão binário

botao_hexadecimal=Button(janela, text="Conversão para Hexadecimal", width=25, command=converter_hexa)
#criação do botão de conversão para headecimal. 'Command' chamará a função criada anteriormente

botao_hexadecimal.place(x=145, y=150) #posicionamento do botão hexadecimal

botao_octa=Button(janela, text="Conversão para Octa", width=20, command=converter_octa)
#criação do botão de conversão para octal. 'Command' chamará a função criada anteriormente
